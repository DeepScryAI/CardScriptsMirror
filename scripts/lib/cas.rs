//! Shared CAS conventions for the producer scripts — the mirror-side copy of
//! the SS0 layer of the ratified card-skin format package.
//!
...
//! factory), both copies are slated to migrate into the `card-compiler`
//! crate; until then any change here must land in both places with the
//! shared vectors updated together.
//!
//! Contents:
